    ...
    def simulate_game(self) -> bool:
        ...
        while not self.is_game_over:
            ...
            if self.inning == 4 and self.half == InningHalf.TOP and len(self.cur_base_runners) == 0 and \
                self.outs == 0 and self.strikes == 0 and self.balls == 0 and \
                (PlayerBuff.TRIPLE_THREAD in self.cur_batting_team.player_buffs[
                    self.cur_batting_team.starting_pitcher] or \
                 PlayerBuff.TRIPLE_THREAD in self.cur_pitching_team.player_buffs[
